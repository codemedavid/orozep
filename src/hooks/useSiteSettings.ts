  ...
  const fetchSiteSettings = async () => {
    try {
      ...
      const settings: SiteSettings = {
        site_name: settingsData.find(s => s.id === 'site_name')?.value || 'Orozep PH',
        site_logo: settingsData.find(s => s.id === 'site_logo')?.value || '/orozeplogo.jpg',
        ...
        hero_badge_text: settingsData.find(s => s.id === 'hero_badge_text')?.value || 'Premium Pink Peptide Essentials',
        ...
        hero_description: settingsData.find(s => s.id === 'hero_description')?.value || 'Orozep PH provides research-grade peptides engineered for precision, purity, and consistency.',
